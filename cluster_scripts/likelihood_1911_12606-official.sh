...
python sample.py /users/rafal.maselek/ML_LHClikelihoods/sampling/parameters.yaml --log_dir /users/rafal.maselek/slurm_scripts/logs/ --start /users/rafal.maselek/1911.12606-EWKinos.csv --start_index $SLURM_ARRAY_TASK_ID
